...
const ENV_KEYS = {
  ...
  // Azure AI Foundry (hosts Azure OpenAI + DeepSeek deployments)
  AZURE_FOUNDRY_ENDPOINT: 'AZURE_FOUNDRY_ENDPOINT',
  AZURE_FOUNDRY_API_KEY: 'AZURE_FOUNDRY_API_KEY',
  AZURE_OPENAI_API_VERSION: 'AZURE_OPENAI_API_VERSION',
  AZURE_GPT41_MINI_DEPLOYMENT: 'AZURE_GPT41_MINI_DEPLOYMENT',
  AZURE_GPT41_DEPLOYMENT: 'AZURE_GPT41_DEPLOYMENT',
  AZURE_DEEPSEEK_R1_DEPLOYMENT: 'AZURE_DEEPSEEK_R1_DEPLOYMENT',
  AZURE_DEEPSEEK_V3_DEPLOYMENT: 'AZURE_DEEPSEEK_V3_DEPLOYMENT',
...
const envMap = new Map<string, string | undefined>([
  ...
  // Azure AI Foundry
  ['AZURE_FOUNDRY_ENDPOINT', process.env.AZURE_FOUNDRY_ENDPOINT || 'mandatory-env-not-set'],
  ['AZURE_FOUNDRY_API_KEY', process.env.AZURE_FOUNDRY_API_KEY || 'mandatory-env-not-set'],
  ['AZURE_OPENAI_API_VERSION', process.env.AZURE_OPENAI_API_VERSION || '2024-10-21'],
  ['AZURE_GPT41_MINI_DEPLOYMENT', process.env.AZURE_GPT41_MINI_DEPLOYMENT || 'gpt-4.1-mini'],
  ['AZURE_GPT41_DEPLOYMENT', process.env.AZURE_GPT41_DEPLOYMENT || 'gpt-4.1'],
  ['AZURE_DEEPSEEK_R1_DEPLOYMENT', process.env.AZURE_DEEPSEEK_R1_DEPLOYMENT || 'DeepSeek-R1-0528'],
  ['AZURE_DEEPSEEK_V3_DEPLOYMENT', process.env.AZURE_DEEPSEEK_V3_DEPLOYMENT || 'DeepSeek-V3.2'],
